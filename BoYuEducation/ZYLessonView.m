...
- (void)dealloc
{
    ...
    _backView = nil;
    [_teacherNameLabel release];
    _teacherNameLabel = nil;
    [_lessonNameLabel release];
    _lessonNameLabel = nil;
    [_lessonTimeLabel release];
    _lessonTimeLabel = nil;
    [_contentLabel release];
    _contentLabel = nil;
    [_fileNameLabelArray release];
    _fileNameLabelArray = nil;
    [_bottomShadowView release];
