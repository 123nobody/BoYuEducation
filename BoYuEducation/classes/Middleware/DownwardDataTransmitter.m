...
//    [_request setURL:url];
    ...
    if (!error) {
        ...
        token = [[[NSString alloc]initWithData:urlData encoding:NSUTF8StringEncoding]autorelease];
        return token;
    }
...
//    NSLog(@"999request:%@", _request);
    ...
    if (!error) {
        urlData = [_request responseData];
        base64String = [[[NSString alloc]initWithData:urlData encoding:NSUTF8StringEncoding]autorelease];
...
//    [_request setURL:url];
    ...
    if (!error) {
        urlData = [_request responseData];
        resultString = [[[NSString alloc]initWithData:urlData encoding:NSUTF8StringEncoding]autorelease];
